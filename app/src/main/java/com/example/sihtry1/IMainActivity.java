...
//        String userId = FirebaseAuth.getInstance().getCurrentUser().getUid();
    ...
    public void createNewReferral(final Context context, String child_first_name, String referral_id, String child_last_name,
                                  String guadian_name, String nrc_id, String rcr_id, String guardian_aadhar_num,
                                  String child_gender, int day_of_birth, int month_of_birth, int year_of_birth, String symptoms,
                                  char blood_group, float asha_measure, float height, float weight, String phone,
                                  String state, String city, int pincode, String address) {
        FirebaseFirestore db = FirebaseFirestore.getInstance();

        DocumentReference newReferralRef = db.collection("referral").document();

        Referral referral = new Referral(child_first_name, referral_id, child_last_name, guadian_name, nrc_id, rcr_id,
